...
assert(indexHtml.includes('src/app.js?v=20260711-admin-mfa-stale-recovery-v2'), 'Admin app.js must be cache-busted so deployed pages do not keep the previous runtime.');
