...
assert(indexHtml.includes('app.js?v=20260708-plan-policy-field-error-v4'), 'Admin runtime must be cache-busted after tab cache enhancement.');
assert(indexHtml.includes('styles.css?v=20260708-plan-policy-field-error-v4'), 'Admin styles must be cache-busted after tab cache enhancement.');
