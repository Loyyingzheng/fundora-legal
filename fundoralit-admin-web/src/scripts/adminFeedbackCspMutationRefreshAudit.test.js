...
assert(indexHtml.includes('app.js?v=20260708-backend-error-surface-v3'), 'app.js must be cache-busted after feedback runtime fixes.');
assert(indexHtml.includes('styles.css?v=20260708-backend-error-surface-v3'), 'styles.css must be cache-busted after CSP/style fixes.');
