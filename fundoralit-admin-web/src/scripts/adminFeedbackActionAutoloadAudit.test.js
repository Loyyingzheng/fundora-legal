...
assert(indexHtml.includes('src/app.js?v=20260708-backend-error-surface-v3'), 'Admin app.js must be cache-busted so deployed pages do not keep the previous runtime.');
