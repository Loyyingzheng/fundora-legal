...
assert(indexHtml.includes('src/app.js?v=20260710-admin-governance-v1'), 'Admin app.js must be cache-busted so deployed pages do not keep the previous runtime.');
