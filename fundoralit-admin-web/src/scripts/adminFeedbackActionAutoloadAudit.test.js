...
assert(indexHtml.includes('src/app.js?v=20260708-other-tab-field-error-v5'), 'Admin app.js must be cache-busted so deployed pages do not keep the previous runtime.');
