...
assert(indexHtml.includes('app.js?v=20260710-admin-governance-v1'), 'app.js must be cache-busted after feedback runtime fixes.');
assert(indexHtml.includes('styles.css?v=20260710-admin-governance-v1'), 'styles.css must be cache-busted after CSP/style fixes.');
