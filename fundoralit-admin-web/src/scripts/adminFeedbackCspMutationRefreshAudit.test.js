...
assert(indexHtml.includes('app.js?v=20260706-housekeeping-schedule-v1'), 'app.js must be cache-busted after feedback runtime fixes.');
assert(indexHtml.includes('styles.css?v=20260706-housekeeping-schedule-v1'), 'styles.css must be cache-busted after CSP/style fixes.');
