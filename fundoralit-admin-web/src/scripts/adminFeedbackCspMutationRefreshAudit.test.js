...
assert(indexHtml.includes('app.js?v=20260711-admin-mfa-stale-recovery-v2'), 'app.js must be cache-busted after feedback runtime fixes.');
assert(indexHtml.includes('styles.css?v=20260711-admin-mfa-stale-recovery-v2'), 'styles.css must be cache-busted after CSP/style fixes.');
