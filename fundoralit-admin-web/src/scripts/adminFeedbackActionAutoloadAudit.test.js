...
assert(indexHtml.includes('src/app.js?v=20260706-feedback-runtime-v4'), 'Admin app.js must be cache-busted so deployed pages do not keep the previous runtime.');
